class Calculator{
    ...
    delete(){
        this.currentOperand = this.currentOperand.toSting().sclice(0,1)

    }
    appendNumber(number){
        // if(number ==='.'&&this.currentOperand.include('.')) return
        // this.currentOperand = this.currentOperand.toSting() + number.toSting()
    ...
    getDisplayNumber(number){
        const stringNumber = number.toSting()
...
const delateButtons = document.querySelectorAll('[data-delete]')
